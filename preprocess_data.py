...
INPUT_FORMAT = "ctxai"  # "json", "xlsx", "dict", "ctxai"
...
if NUM_WORKERS > 0 and INPUT_FORMAT != "json":
    print("Choose NUM_WORKER = 0 or 1, since you have a single file to process!")
    raise ValueError("Invalid combination of INPUT_FORMAT and NUM_WORKERS")
...
def get_dataset(data_dir, input_format, shuffle=False):
    ...
    elif input_format in ["xlsx", "ctxai"]:
